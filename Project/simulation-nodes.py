...
class Simulation(object):
	...
	def drawPlot(self, y_data, x_data, title, xlabel, ylabel, legend):
		...
		plt.xlabel(xlabel)
		plt.ylabel(ylabel)
		error = 0.05 * np.array(x_data)
		plt.errorbar(y_data, x_data, yerr=error, color="red")
		plt.legend(legend)
		plt.show()
...
def main():
	...
	iterations = 100
	tests = 30
	list_nodes = list(range(10,200,5))
	...
	s.drawPlot(list_nodes, all_costs, "Number of Nodes", "Number of Nodes", "Money", legend)
