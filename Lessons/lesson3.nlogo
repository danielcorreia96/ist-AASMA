...
to-report BDI-filter
  ...
  [ifelse desire = "grab"
    [set x adjacent-position-of-occupied-ramp
      report build-intention desire item 0 x item 1 x
    ]
    [if desire = "drop"
      [set x adjacent-position-of-free-shelf cargo-box-color
      report build-intention desire item 0 x item 1 x
      ]
    ]
  ]
